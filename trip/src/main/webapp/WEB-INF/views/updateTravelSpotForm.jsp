								...
								<td colspan="2">
									<div class='file-input'>
										<input type='file' id="file1" name="uploadFile1"
											...
											for="file1" class='label'>${travel.imageFile1}</label>
									</div>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<div class='file-input'>
										<input type='file' id="file2" name="uploadFile2"
											...
											class='label' for="file2" class="b">${travel.imageFile2}</label>
									</div>
								</td>
							</tr>
								...
								<td colspan="2">
									<div class='file-input'>
										<input type='file' id="file3" name="uploadFile3"
											...
											class='label' for="file3" class="b">${travel.imageFile3}</label>
									</div>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<div class='file-input'>
										<input type='file' id="file4" name="uploadFile4"
											...
											class='label' for="file4" class="b">${travel.imageFile4}</label>
									</div>
								</td>
							</tr>
